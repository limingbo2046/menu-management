...
foreach($project in $projects) {
    ...
    & dotnet nuget push ($projectName + "." + $version + ".nupkg") --api-key oy2ig3tkpbpyzj2iwf6==remove me==afntm6wwen24uhnyo3cnyayy4k4 --source https://api.nuget.org/v3/index.json
}
